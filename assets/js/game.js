...
var endGame = function () {
  ...
  if (playerInfo.health > 0) {
    window.alert(
      `Great job, you've survived the game! You no have a high score of ${playerInfo.money}.`
    );
    if (window.localStorage.getItem("highScore") === null) {
      window.localStorage.setItem("highScore", 0);
    }
    if (playerInfo.money > parseInt(window.localStorage.getItem("highScore"))) {
      window.alert("Congratulations! You've beat the high score!");
      window.localStorage.setItem("highScore", playerInfo.money);
      window.localStorage.setItem("highScorePlayer", playerInfo.name);
    } else {
      window.alert("Too bad! You did not beat the high score.");
    }
  } else {
